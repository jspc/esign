...
// IncludeLicense set the call query parameter include_license
func (op *GetOp) IncludeLicense(val string) *GetOp {
	if op != nil {
		op.QueryOpts.Set("include_license", val)
	}
	return op
}
...
// IncludeLicense set the call query parameter include_license
func (op *ListOp) IncludeLicense(val string) *ListOp {
	if op != nil {
		op.QueryOpts.Set("include_license", val)
	}
	return op
