...
// IncludeTrialEligibility set the call query parameter include_trial_eligibility
func (op *GetOp) IncludeTrialEligibility(val string) *GetOp {
	if op != nil {
		op.QueryOpts.Set("include_trial_eligibility", val)
	}
	return op
}
