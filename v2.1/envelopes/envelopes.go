...
// IncludeAgreementType set the call query parameter include_agreement_type
func (op *DocumentsListOp) IncludeAgreementType(val string) *DocumentsListOp {
	if op != nil {
		op.QueryOpts.Set("include_agreement_type", val)
	}
	return op
}
...
// Locale is the user's locale code. Valid values are:
// - `zh_CN`
// - `zh_TW`
// - `nl`
// - `en`
...
// - `ru`
// - `es`
func (op *ListAuditEventsOp) Locale(val string) *ListAuditEventsOp {
	if op != nil {
		op.QueryOpts.Set("locale", val)
	}
	return op
}
